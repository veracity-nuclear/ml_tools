...
class SAGE(Graph):
    ...
    @property
    def aggregator(self) -> CategoricalDimension:
        return self.fields["aggregator"]

    @aggregator.setter
    def aggregator(self, value: CategoricalDimension) -> None:
        self.fields["aggregator"] = value
    ...
    def __init__(self,
                 ...
                 aggregator:               CategoricalDimension = CategoricalDimension(['mean']),
        ...
        self.fields['variant']   = CategoricalDimension(['SAGE'])
        self.fields['aggregator'] = aggregator
