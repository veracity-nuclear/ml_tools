...
class PODSearchSpace(SearchSpace):
    ...
    input_features : Optional[FeatureSpec]
        Default input features. Must be provided for POD search spaces.
    predicted_features : Optional[FeatureSpec]
        Default predicted features. Must be provided for POD search spaces.
    Notes
    -----
    ...
    def __init__(self,
        ...
        if input_features is None:
            assert "input_features" in dimensions.fields, \
                "PODSearchSpace requires 'input_features' either as defaults or in dimensions"
        if predicted_features is None:
            assert "predicted_features" in dimensions.fields, \
                "PODSearchSpace requires 'predicted_features' either as defaults or in dimensions"
